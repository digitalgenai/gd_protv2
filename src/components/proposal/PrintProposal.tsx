...
export default function PrintProposal() {
  ...
  return createPortal(
    <div id="print-area">
      {/* <table>, não <div> — cabeçalho (logo + "Proposta Comercial" + código) vai no <thead>,
         que os navegadores repetem automaticamente no topo de CADA página impressa em que o
         documento transborda (mesmo recurso já usado na tabela de itens e na galeria de
         destaque). Sem isso, uma proposta que passa de 1 página (ex.: Condições Gerais/
         assinatura empurradas pra página 2) nascia colada no topo da folha, sem logo nem faixa.
         Só o cabeçalho enxuto repete — o bloco de dados do cliente (.pr-meta) fica só na 1ª
         página, senão repetiria uma grade grande em toda página à toa. */}
